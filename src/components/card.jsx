  ...
  return (
    <>
      {cardSize === "large" ? (
       ...
       rounded-card-large z-20 transition-all duration-200 lg:last:mb-0 last:mb-14"
        >
        ...
        <div className="flex flex-col justify-center items-center p-card-small w-card h-card-small bg-white rounded-card-small z-0 transition-all duration-200 lg:last:mb-0 last:mb-24">
